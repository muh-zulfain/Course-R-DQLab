...
# Cara 2
diamonds_c2 <- ggplot(data = diamonds) +
...
diamonds_c3 <- 
  ggplot() +
  geom_point(data = diamonds, mapping = aes(x = carat, y = price, colour = clarity)
  )		 
...
jalan_kabkota_plot +
  ...
  labs(
    ...
    subtitle = "Berdasarkan data tahun 2008, garis vertikal menunjukkan panjang jalan 100 Km",
    caption = "Data: INDO-DAPOER, The World Bank"
  ) +
